<template>
  <el-row class="panel-group" :gutter="40">
    <el-col :xs="4" :sm="8" :lg="4" class="card-panel-col">
    ...
    <el-col :xs="4" :sm="8" :lg="4" class="card-panel-col">
      <div class='card-panel' @click="handleSetLineChartData('newVisitis')">
        <div class="card-panel-icon-wrapper seeuser">
          <svg-icon icon-class="seeuser" class-name="card-panel-icon" />
        </div>
        <div class="card-panel-description">
    ...
    <el-col :xs="4" :sm="8" :lg="4" class="card-panel-col">
      <div class='card-panel' @click="handleSetLineChartData('newVisitis')">
        <div class="card-panel-icon-wrapper icon-people">
          <svg-icon icon-class="ic_pageviews" class-name="card-panel-icon" />
        </div>
        <div class="card-panel-description">
          <div class="card-panel-text">今日PV</div>
          <count-to class="card-panel-num" :startVal="0" :endVal="102400" :duration="2600"></count-to>
    ...
    <el-col :xs="4" :sm="8" :lg="4" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('purchases')">
        <div class="card-panel-icon-wrapper icon-money">
          <svg-icon icon-class="wenzhang" class-name="card-panel-icon" />
        </div>
        <div class="card-panel-description">
    ...
    <el-col :xs="4" :sm="8" :lg="4" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('shoppings')">
        <div class="card-panel-icon-wrapper icon-shoppingCard">
          <svg-icon icon-class="dianzan" class-name="card-panel-icon" />
        </div>
        <div class="card-panel-description">
